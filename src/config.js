...
export const restList = [
  {
    ...
    data: {
      ...
      slugs: {
        restaurant:
          "agrawals-juice-and-fast-food-centre-ghatkopar-east-ghatkopar-vikhroli",
        city: "mumbai",
      },
      cityState: "5",
      address:
        "Opposite Odeon Shopping Center, Vallabh Lane, Ghatkopar East, Mumbai",
  ...
  },
  {
    ...
    data: {
      ...
      cityState: "5",
      address:
        "Ground Floor, Value Platinum, Seventh Road, Rajawadi, Vidya Vihar East, Ghatkopar East, Mumbai",
      locality: "Ghatkopar East",
      parentId: 110785,
      unserviceable: false,
      veg: true,
  ...
  },
  {
    ...
    data: {
      ...
      cityState: "5",
      address:
        "B-16, KAILAS INDL. COMPLEX, VEER SAVARKAR ROAD, POWAI VIKHROLI ROAD, VIKHROLI WEST, MUMBAI - 400079, Greater Mumbai Ward-S, Greater Mumbai, Maharashtra-400079",
  ...
  },
  {
    ...
    data: {
      ...
      slugs: {
        restaurant:
          "natural-ice-cream-near-ghatkopar-station-ghatkopar-vikhroli",
        city: "mumbai",
      },
      cityState: "5",
      address:
        "6 & 7, Nand Ashish, R. B. Mehta Marg, Patel Chowk, Near Ghatkopar Station, Ghatkopar East, Mumbai, Maharashtra 400077",
  ...
  },
  {
    ...
    data: {
      ...
      cuisines: ["Fast Food", "Biryani", "Snacks", "Beverages"],
      tags: [],
      costForTwo: 25000,
      ...
      slugs: {
        restaurant:
          "gupta-sandwiches-&-snacks-ghatkopar-vikhroli-ghatkopar-vikhroli",
        city: "mumbai",
      },
      cityState: "5",
  ...
  },
  {
    ...
    data: {
      ...
      cityState: "5",
      address:
        "Shop No 2, Girivan Pristino, 57, Corner of 19th Road, &, DK Sandu St, Chembur, Mumbai, Maharashtra 400071",
      locality: "Chembur",
      parentId: 2,
      unserviceable: false,
      veg: false,
